#!/usr/bin/env python
"""Run the BERT-vs-Gemini data-extraction PoC without installing the package (`pip install -e .` not required)."""
...
from email_poc.extraction.cli import main  # noqa: E402
import os
